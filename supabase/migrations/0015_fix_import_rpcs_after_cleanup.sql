-- Donario: Fix import RPCs tras la limpieza de columnas sync.
-- 0012 dropeó device_id/client_uuid/version pero los RPCs de 0002/0010
-- quedaron referenciando esas columnas → error 42703 al importar.
-- Aquí reescribimos los RPCs con la firma nueva (sin p_device_id) y sin
-- tocar device_id/client_uuid/version (que ya no existen).
